...
<Tip>In APIs that support user_id or user_external_id, you can either use the Partner API key and explicitly specify the user_id, or use the user-based access token and omit these parameters since they are distinguished through the access token.</Tip>
