...
api: 'POST https://orderservice.withbenji.com/orders/external'
---
...
<ParamField body="merchant_external_id" type="string" required>
  The external identifier of the merchant in your system
</ParamField>
...
<ParamField body="users" type="object" required>
  ...
  <Expandable title="properties" defaultOpen="true">
    <ParamField body="merchant_external_id" type="string" optional>
...
<ParamField body="transaction_sub_total" type="integer" required>
