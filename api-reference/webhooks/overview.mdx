...
<Expandable title="User Events">
    - user_partner_authentication_created : Indicating a user has successfully connected with a partner through the Benji Platform
</Expandable>
...
<Expandable title="Campaign Events">
    ...
    - campaign_ended : Indicating a campaign has ended (either manually or by surpassing its end date)
</Expandable>
