...
<Warning>Make sure to exchange the token returned by the Connect SDK promptly following a succesful user connect flow. The exchange token is valid for 15 minutes after the succesful callback flow</Warning>
