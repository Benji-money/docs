...
> **Technical Users:** For details on how Square data is used in transactions, see the [API Reference: Transactions](../api-reference/endpoint/transactions/overview.mdx).
...
- [API Reference: Transactions](../api-reference/endpoint/transactions/overview.mdx) 