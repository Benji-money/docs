...
For **Redeem** type campaigns, this means the member will get a multiplier on the conversion rate per dollar defined in the triggers section above. <img src="/images/pilot/campaign_multipliers.png" alt="title" />
