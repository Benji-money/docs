...
The Benji Platform supports 4 types of different campaign types :
...
In this section you can configure the action the trigger to activate the campaign. This action essentially triggers a rule engine, that validates the conditions associated with the campaign, and attaches any configured multipliers to the transaction if the connected member is eligible for a multiplier.
